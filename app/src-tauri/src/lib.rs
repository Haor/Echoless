...
use bin_resolve::{
    echoless_bin, echoless_command, localvqe_library_path, process_tap_helper_bin,
    suppress_child_console,
};
#[cfg(test)]
use platform::{
...
use proc::{
    ...
    terminate_run, JsonlLineEvent, RunChild, RunState, JSON_COMMAND_TIMEOUT,
    MODEL_DOWNLOAD_TIMEOUT, NVAFX_INSTALL_TIMEOUT, PROBE_DELAY_TIMEOUT, STREAM_TAIL_LIMIT_BYTES,
